...
<style>
    ...
    * {
    ...
    .other:before {
        ...
        height: 100%;
        width: 100%;
        background: linear-gradient(45deg, rgba(15, 53, 91, 0.903), rgba(36, 51, 66, 0.421));
    }
    ...
    <div class="contact">
        <div class="other">
            <div class="info">
                ...
                <h3>Email</h3>
                <div class="svg-wrap">
                    <a href="mailto:connor@connorgaunt.com"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <h3>Connect</h3>
                <div class="svg-wrap">
                    <a href="http://instagram.com/connorgaunt" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                            <path
                    ...
                    <a href="http://twitter.com/connor_gaunt" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 612 612">
                            <path
                    ...
                    <a href="http://linkedin.com/in/connorgaunt" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="form">
            ...
            <form action="">
                ...
                <div class="flex-rev">
                    <input type="email" placeholder="you@gamil.com" name="email" id="email" />
                    <label for="email">Your Email</label>
                </div>

                <div class="flex-rev">
                    <textarea placeholder="Write anything ..." name="message" id="message"></textarea>
